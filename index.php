	...
	<div class="row" >
  		<div class="col-lg-8">
		    ...
		    <address>
				...
				<ul>
					<li>Custom software solutions for your greatest ideas.</li>
		    ...
		    <address>
		    	<strong>TapThere, Inc</strong> <a href="http://tapthere.com">http://tapthere.com</a><br>
		    ...
		    <address>
		    	<strong>Mobile Gates</strong> <a href="http://www.mobilegates.com">http://mobilegates.com</a><br>
			...
			<address>
				<strong>Expitrans Inc</strong> <a href="http://expitrans.com">http://expitrans.com</a><br>
			...
			<address>
				<strong>K. Hovnanian Homes</strong> <a href="http://www.khov.com">http://khov.com</a><br>
			...
			<h3 class="page-header"><i class="icon-book icon-fixed-width"></i> Education</h3>
		    <address>
			...
			<h3 class="page-header"><i class="icon-comments-alt icon-fixed-width"></i> Foreign Languages</h3>
		    <address>
  		...
  		<div class="col-lg-4">
		    ...
		    <p><i class="icon-globe icon-fixed-width"></i> I have lived in England, California, Chile, and Argentina.</p>
